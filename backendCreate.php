...
function create_shift($start, $end, $siteOwner)
{
  global $db;
  $stmt = $db->prepare("INSERT INTO appointment (appointment_start, appointment_end, siteOwner_id) VALUES (:start, :end, :siteOwner)");
  $stmt->bindParam(':start', $start);
  $stmt->bindParam(':end', $end);
  $stmt->bindParam(':siteOwner', $siteOwner);
  $stmt->execute();
}
